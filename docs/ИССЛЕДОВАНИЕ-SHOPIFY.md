...
```
/sh 4111111111111111 12 30 123             # Проверка через случайный Shopify-магазин
/sh 1 4111111111111111 12 30 123           # Проверка через магазин с товаром <= $1.00
/sh 5 4111111111111111 12 30 123           # Проверка через магазин с товаром $1.00 - $5.00
/sh 20 4111111111111111 12 30 123          # Проверка через магазин с товаром $5.00 - $20.00
/mass sh                                   # Массовый чек до 20 карт через Shopify
```
